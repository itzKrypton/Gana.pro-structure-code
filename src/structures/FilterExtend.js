...
module.exports = class PlayerExtends extends KazagumoPlayer {
   ...
   */
  setlofi(value) {
      if (typeof value !== 'boolean') return console.error('[ setlofi Function Error ]: Please provide a valid value (true/false).');
      ...
      if (this.lofi) {
        this.speedAmount = 0.9;
        this.reverbAmount = 0.9;
   ...
   */
  setSlow(value) {
      if (typeof value !== 'boolean') return console.error('[ setSlow Function Error ]: Please provide a valid value (true/false).');
   ...
   */
  setDarth(value) {
    if (typeof value !== 'boolean') return console.error('[ setDarth Function Error ]: Please provide a valid value (true/false).');
    ...
    if (this.darth) {
      this.speedAmount = 0.975;
      this.pitchAmount = 0.5;
      this.rateAmount = 0.8;
   ...
   */
  setDance(value) {
      if (typeof value !== 'boolean') return console.error('[ setDance Function Error ]: Please provide a valid value (true/false).');
      ...
      if (this.dance) {
        this.speedAmount = 1.25;
        this.pitchAmount = 1.25;
        this.rateAmount = 1.25;
  ...
  clearfilter() {
      ...
      if (this.nightcore) this.nightcore = false;
      if (this.vaporwave) this.vaporwave = false;
      if (this.lofi) this.lofi = false;
      if (this.slow) this.slow = false;
      if (this.darth) this.darth = false;
      if (this.dance) this.dance = false;
